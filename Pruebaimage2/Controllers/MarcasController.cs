...
namespace Pruebaimage2.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(Pruebaimage2DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Marcas != null ? 
                          ...
                          Problem("Entity set 'Pruebaimage2DbContext.Marcas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Pruebaimage2DbContext.Marcas'  is null.");
            }
            var marca = await _context.Marcas.FindAsync(id);
            if (marca != null)
            {
